...
export const NP_MONTHS_DATA: Array<[number[], number]> = [
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1970 BS
  [[31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30], 365], // 1971 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30], 365], // 1972 BS
  [[30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31], 365], // 1973 BS
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1974 BS
  [[31, 31, 32, 32, 31, 31, 30, 29, 30, 29, 30, 30], 366], // 1975 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], 366], // 1976 BS
  [[30, 32, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31], 365], // 1977 BS
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1978 BS
  [[31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30], 365], // 1979 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], 366], // 1980 BS
  [[31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30], 365], // 1981 BS
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1982 BS
  [[31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30], 365], // 1983 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], 366], // 1984 BS
  [[31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30], 365], // 1985 BS
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1986 BS
  [[31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30], 365], // 1987 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], 366], // 1988 BS
  [[31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1989 BS
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1990 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30], 365], // 1991 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31], 366], // 1992 BS
  [[31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1993 BS
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1994 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30], 365], // 1995 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31], 366], // 1996 BS
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1997 BS
  [[31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], 365], // 1998 BS
  [[31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], 366], // 1999 BS
