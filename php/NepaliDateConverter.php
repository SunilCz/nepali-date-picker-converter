...
class NepaliDateConverter
{
    ...
    private static function getNepaliMonthsData(): array
    {
        ...
        return [
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1970 BS
            [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30], // 1971 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30], // 1972 BS
            [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31], // 1973 BS
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1974 BS
            [31, 31, 32, 32, 31, 31, 30, 29, 30, 29, 30, 30], // 1975 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], // 1976 BS
            [30, 32, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31], // 1977 BS
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1978 BS
            [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30], // 1979 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], // 1980 BS
            [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30], // 1981 BS
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1982 BS
            [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30], // 1983 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], // 1984 BS
            [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30], // 1985 BS
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1986 BS
            [31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30], // 1987 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], // 1988 BS
            [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30], // 1989 BS
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1990 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30], // 1991 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31], // 1992 BS
            [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30], // 1993 BS
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1994 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30], // 1995 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31], // 1996 BS
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1997 BS
            [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 1998 BS
            [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31], // 1999 BS
