...
```html
<script src="https://unpkg.com/nepali-date-picker-converter@0.1.19/dist/bundle.umd.js"></script>
```
...
<script type="module">
  import {
    adToBs,
    bsToAd,
  } from "https://unpkg.com/nepali-date-picker-converter@0.1.19/dist/index.mjs";
